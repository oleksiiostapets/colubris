...
class page_manager_tasks extends page_tasksfunctions {
    ...
    function initMainPage() {
    	...
    	$this->add('View_TasksCRUD',array(
    			...
    			'edit_fields'=>array('name','descr_original','priority','status','estimate','spent_time','assigned_id'),
    			'show_fields'=>array('name','descr_original','priority','status','estimate','spent_time','assigned'),
    			));
    }
