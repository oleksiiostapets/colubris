...
(function($) {
    ...
    $.Autocompleter.prototype.position = function() {
        ...
        var inputBottom = offset.top + this.dom.$elem.outerHeight() - $(window).scrollTop();;
...
                $li.html( $li.html().replace(reg, function(q){ return '<span class="highlight">'+q+'</span>'; }));
                $ul.append($li);
                if (first === false) {
            ...
            var $a=$('<li class="all"></li>').html('<a href="?q='+filter+'">Все результаты поиска</a>');
            $ul.append($a);
