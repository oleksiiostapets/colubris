...
class ApiTaskAddRightTest extends PHPUnit_Framework_TestCase {
    ...
    public function testCreateProject(
        ...
        $m['name'] ='TestProject_ApiTaskAddRightTest_'.$hash;
        $m->save();
    ...
    public function testCreateQuote(
        ...
        $m['name'] = 'TestQuote_ApiTaskAddRightTest_'.$hash;
    ...
    public function testCreateRequirement(
        ...
        $m['name'] = 'TestRequirement_ApiTaskAddRightTest_'.$hash;
        $m['quote_id'] = $quote->id;
        $m->save();
    ...
    public function testCreateTask(
        ...
        $data = [
            'name'       => 'TestTask_ApiTaskAddRightTest_'.$hash,
