 ...
 * Time: 23:46
 */
class UIPageAccessClientsRightTest extends PHPUnit_Framework_TestCase {
    ...
    protected function createUser() {
        ...
        $this->current_user_rights = $this->app->add('Model_User_Right')
            ->setRights($this->current_user->id,['can_see_clients'])
        ;
    }
    ...
    public function testPages() {
        ...
        $this->assertContains('Clients', $this->webDriver->getTitle());
