 ...
 * Time: 23:46
 */
class UIPageAccessReportsRightTest extends PHPUnit_Framework_TestCase {
    ...
    protected function createUser() {
        ...
        $this->current_user_rights = $this->app->add('Model_User_Right')
            ->setRights($this->current_user->id,['can_see_reports'])
        ;
    }
    ...
    public function testPages() {
        ...
        $this->assertContains('Reports', $this->webDriver->getTitle());
