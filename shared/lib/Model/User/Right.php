...
class Model_User_Right extends SQL_Model{
    ...
    private $client_pattern = 'can_see_tasks,can_add_task,can_edit_task,can_add_comment_to_task,can_see_projects,can_edit_projects,can_see_quotes,can_edit_quote,can_add_projects,can_add_quote,can_add_requirement,can_edit_requirement,can_add_comment_to_requirement,can_see_settings,can_edit_settings,can_see_dashboard';
